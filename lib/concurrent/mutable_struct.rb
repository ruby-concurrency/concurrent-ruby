require 'concurrent/collection/abstract_struct'
...
module Concurrent
  ...
  module MutableStruct
    include Collection::AbstractStruct
    ...
    #
    #   @return [Collection::AbstractStruct] a new struct with the new values
    #
    ...
    FACTORY = Class.new(SynchronizationObject) do
      def define_struct(name, members, &block)
        synchronize do
          clazz = Collection::AbstractStruct.define_struct_class(MutableStruct, SynchronizationObject, name, members, &block)
