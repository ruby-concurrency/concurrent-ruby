RSpec.shared_examples :atomic_integer do
  ...
  context 'construction' do
    ...
    it 'raises an exception if the initial value is not a Integer' do
  ...
  context '#value=' do
    ...
    it 'sets the #value to the given `Integer`' do
    ...
    it 'raises and exception if the value is not a `Integer`' do
      atomic = described_class.new(0)
      expect {
        atomic.value = 'foo'
...
module Concurrent
  ...
  RSpec.describe MutexAtomicInteger do
