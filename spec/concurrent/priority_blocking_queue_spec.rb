...
module Concurrent
  ...
  describe RubyPriorityBlockingQueue do
  ...
  describe PriorityBlockingQueue do
    if Concurrent.on_jruby?
      ...
      it 'inherits from RubyPriorityBlockingQueue' do
        expect(PriorityBlockingQueue.ancestors).to include(RubyPriorityBlockingQueue)
      end
    end
  end
end
